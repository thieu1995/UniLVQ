#!/usr/bin/env python
# Created by "Thieu" at 10:05, 12/05/2025 ----------%
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from sklearn.datasets import load_iris
from unilvq import Lvq3Classifier, Data
...
## Train and test
model = Lvq3Classifier(n_prototypes_per_class=1, learning_rate=0.1, window=0.3, epsilon=0.2, seed=42)
