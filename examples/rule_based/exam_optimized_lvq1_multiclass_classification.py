#!/usr/bin/env python
# Created by "Thieu" at 10:07, 12/05/2025 ----------%
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from sklearn.datasets import load_iris
from unilvq import OptimizedLvq1Classifier, Data
...
## Train and test
model = OptimizedLvq1Classifier(n_prototypes_per_class=1, initial_learning_rate=0.5, learning_decay=0.99, seed=42)
