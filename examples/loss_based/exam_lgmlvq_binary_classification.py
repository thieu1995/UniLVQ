#!/usr/bin/env python
# Created by "Thieu" at 10:03, 15/05/2025 ----------%
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from sklearn.datasets import load_breast_cancer
from unilvq import LgmlvqClassifier, Data
...
## Train and test
model = LgmlvqClassifier(n_prototypes_per_class=1, epochs=500, batch_size=16,
                       optim="Adam", optim_paras={"lr": 0.0001},
